...
<div class="col-xl-8 mx-auto">
	...
	<div class="card">
		<div class="card-body p-4">
			<h5 class="mb-4 text-center">Update Room</h5>
			<form class="row g-3" method="POST" action="{{route('update.room',$editData->id)}}" enctype="multipart/form-data">
				@csrf
						<div class="col-md-4">
							...
							<input type="text" name='roomtype_id' class="form-control" id="input1" value="{{$editData['roomtype']}}">
						</div>
						...
						<div class="col-md-6">
							...
							<img  src="{{(!empty($editData->image)) ? url('upload/rooming/'.$editData->image)
						...
						<div class="col-md-6">
							...
							<div class="row  " id='preview_img'>
								<div class="col">
										...
										<img  src="{{(!empty($img->multi_image)) ? url('upload/rooming/multi_img/'.$img->multi_image)
						...
						<div class="col-md-12">
							...
							<textarea name='short_desc'class="form-control" id="input11" rows="6">{{$editData->short_desc}}</textarea>
						</div>

						<div class="col-md-12">
							<label for="input11" class="form-label"> Description</label>
							<textarea name='description'class="form-control" id="editor"  rows="10">{{$editData->description }}</textarea>
						</div>		
						 {{-- Facility  --}}
			<div class="row mt-2">
											...
											<div class="roomnoHide" id="roomnoHide">
												...
												<form action="{{route('store.room.no',$editData->id)}}" method="POST">
													...
													<div class="col-md-4 text-center">
														<button type="submit" class="btn btn-outline-success mt-4 " id="input2" value="{{$editData->room_capacity}}"> Save </button>
													</div>
