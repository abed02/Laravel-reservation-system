                                ...
                                <form action="{{ route('team.update') }}" method="post" enctype="multipart/form-data">
									...
									<div class="card-body">
										...
										<div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary">
												<input type="text" class="form-control" name='postion' value='{{$team->postion}}' />
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-sm-3">
											...
											<div class="col-sm-9 text-secondary">
												<input type="text" class="form-control"name='facbook' value='{{$team->facbook}}'  />
											</div>
										</div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            alt="Error " id='showImage' class="rounded-circle p-1 bg-primary" width="80">
											<div class="mt-3">
											</div>
										</div>
