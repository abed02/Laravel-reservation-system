                                ...
                                <form action="{{ route('book.area.update') }}" method="post" enctype="multipart/form-data">
									...
									<div class="card-body">
                                        ...
                                        <div class="row mb-3">
											...
											<div class="form-group col-sm-9 text-secondary">
												<input type="text" class="form-control" name='url_link' value ="{{$book->url_link}}" />
											</div>
										</div>
										...
										<div class="row mb-3">
											...
											<div class="form-group col-sm-9 text-secondary">
												<textarea type="text" class="form-control"name='short_desc'   >{{$book->short_desc}}</textarea>
											</div>
										</div>
                                        ...
                                        <div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary">
                                            <img src="{{ url(asset($book->image)) }}" 
                                            alt="Error " id='showImage' class="rounded-circle p-1 bg-primary" width="80" height='90'>
											<div class="mt-3">
											</div>
										</div>
