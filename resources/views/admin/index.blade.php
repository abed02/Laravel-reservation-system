...
@php
  ...
  $completeprice = App\Models\Booking::where('status','1')->sum('total_price');
  $pendingprice = App\Models\Booking::where('status','0')->sum('total_price');
						...
						<div class="card-body">
							<div class="d-flex align-items-center">
								<div>
									...
									<p class="mb-0 font-13">Today Booking:  {{ count($todaybooking) }}</p>
					   ...
					   <div class="card-body">
						   <div class="d-flex align-items-center">
							   <div>
								   ...
								   <h4 class="my-1 text-warning">${{($completeprice)}}</h4>
								   <p class="mb-0 font-13">Comming :${{$pendingprice}}</p>
